...
flowchart TD
	id1([UXPROD-1927: Implement reference records - https://issues.folio.org/browse/UXPROD-1927]) --> id2{UXPROD-1535: Create Inventory Settings UI}
	...
	id200([UXPROD-1535]) --> UICR-172 & UIDATIMP-1286
	end
